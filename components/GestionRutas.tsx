...
// Pantalla de gestión de rutas (crear, editar, renombrar, quitar clientes,
// eliminar). La usan admin, repartidor y preventista por igual — cualquiera
// de ellos puede armar y modificar rutas.
