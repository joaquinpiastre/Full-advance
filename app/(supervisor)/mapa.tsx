...
export default function MapaSupervisor() {
  ...
  if (!clientes.length) {
    return (
      <View style={styles.center}>
        <Text style={styles.vacio}>No hay clientes en la ruta elegida</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <MapaRuta clientes={clientes} visitados={visitados} color={COLORS.supervisor} />
    </View>
  );
}
